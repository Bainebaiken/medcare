...
class NoPhoneRegisterScreen extends StatelessWidget {
  const NoPhoneRegisterScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SpacerWidget.buildSpacer(AppDimensions.getResponsiveHeight(context, 2.5)),
              GestureDetector(
                onTap: () => Get.to(() => const EmailRegisterScreen()), 
                child: TextField(
                  decoration: InputDecoration(
                    labelText: 'Email',
              ...
              ElevatedButtonWidget.buildElevatedButton(
                onPressed: () => Get.to(() => const EmailRegisterScreen()),
                text: 'Register',
              ),
              SpacerWidget.buildSpacer(AppDimensions.getResponsiveHeight(context, 2.5)),
              GestureDetector(

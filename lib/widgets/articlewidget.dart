    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: AppDimensions.getResponsiveHeight(context, 1)),
          buildArticleCard(context, controller, 'Turning Bad Habits into Healthy Habits: Tips for Living Better', 'Jan 10, 2023', 'assets/healthtip.jpg'),
          SizedBox(height: AppDimensions.getResponsiveHeight(context, 1)),
          buildArticleCard(context, controller, 'Mental Health Awareness: Breaking the Stigma', 'Jan 08, 2023', 'assets/health.jpg'),
